...
### Data class
We use Data class in [Vector](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/geometry/Vector.java) and [Element](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/element/Element.java).
...
### Switch Statements
We start to have the **Switch Statements** code smell when we remove our image from model and made the images independent of the objects. The problem is that we cannot remove completly this dependence because in the game, each object as their own image. In case of the [Arena](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/arena/Arena.java), the [Ship](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/ship/Ship.java) and the [Fragment](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/wall/Fragment.java) we do not need to use switch statements because we have only one type of object in the game. However the [Enemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/Enemy.java) and the [Shot](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/shots/Shot.java) have different objects in the game (Enemies: [OldEnemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/enemyvariants/OldEnemy.java), [YoungEnemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/enemyvariants/YoungEnemy.java)), [WiseEnemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/enemyvariants/WiseEnemy.java), [StrongEnemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/enemyvariants/StrongEnemy.java), [SuperiorEnemy](https://github.com/FEUP-LPOO/lpoo-2020-g16/blob/intermediate/src/main/java/com/spaceinvaders/model/enemy/enemyvariants/SuperiorEnemy.java)) ; (Shots: WeakShot, ImmatureShot, SlickShot, PowerfulShot, LegendaryShot). We did not use classes to represent each type of shots because shots has only the Damage behavior and Movable behavior, and instead of having a method in the enemy class: { return new ImmatureShot(); } we can simply have {return new Shot(...)} (As the professor said in the final class). The problem is that we need to have an id to associate the object with the image. We decide to use as an id, a String representing the name of the image, which we use it in the imagesFactories. And then, when we pass the image name to the factory, we could not avoid the switch statment, because, depending of the image name, we need to produce a different image. This smell is not a big problem because we only needed two switch statements
