...
public class BoxTest {
    ...
    public void containsBoxTest() {
        ...
        assertFalse(box.contain(new Box(new Position(50, 50), new Size(100, 50))));
        assertFalse(box.contain(new Box(new Position(50, 50), new Size(200, 200))));
        assertTrue(box.contain(new Box(new Position(120, 120), new Size(50, 50))));
    }
}
